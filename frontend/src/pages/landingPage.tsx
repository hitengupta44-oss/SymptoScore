        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 grid-rows-3 gap-6 h-auto lg:h-[800px]">
            ...
            <GlowCard className="md:col-span-1 md:row-span-1 p-6">
              ...
              <h3 className="text-lg font-bold text-slate-900">98.2%</h3>
            ...
            <GlowCard className="md:col-span-1 md:row-span-1 p-6">
              ...
              <h3 className="text-lg font-bold text-slate-900">&lt; 200ms</h3>
            ...
            <GlowCard className="md:col-span-1 md:row-span-1 p-6 relative overflow-hidden">
               ...
               <p className="font-bold text-slate-700">Active Users</p>
               <p className="text-xs text-slate-400 mt-2">Trust SymptoScore monthly.</p>
            </GlowCard>
